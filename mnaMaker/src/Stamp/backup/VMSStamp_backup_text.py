...
#    text +='\tOmegaxold_M = 1000000.;\n'
#    text +='\tOmegaold_M = 0.;\n\n'
#    text +='\tOmegaold_M = Omega_M;\n\n'
#    text +='\tOmegaxold_M = Omegaold_M;\n'
    text +='\tJw = ('+comp['hh']+'*'+comp['tau']+')/('+comp['hh']+'+'+comp['tau']+');\n\tJv = -'+comp['eta']+'*'+comp['lambda']+'*cosh('+comp['eta']+'*Un_M);\n\n'
    text +='\tOmega_M = (Jw*Omegaxold_M/'+comp['hh']+')+Jw*'+comp['lambda']+'*sinh('+comp['eta']+'*Un_M);\n'
    text +='\tFwv = -Jv*(Un_M-Uo_M)-(1/Jw)*(Omega_M-Omegaxold_M);\n'
    text +='\tGGeq_M = Jw*Jv;\n\tIIeq_M = Omegaxold_M + Jw*Jv*Omegaxold_M - Jw*Fwv;\n\n'
#    text +='\tOmega_M = 0.;\n'
    text +='\tGeq_M = 1/((1.e1*Omega_M*'+comp['dist']+')+(1.e5*(1-Omega_M*'+comp['dist']+')));\n\n'
#    text +='\tGeq_M = 0.;\n\n'
    text +='\tIeq_M = (1-Omega_M)*'+comp['alpha']+'*(1-exp(-'+comp['beta']+'*Un_M))+Omega_M*'+comp['gamma']+'*sinh('+comp['delta']+'*Un_M);\n\n'
#    text +='\tIeq_M = 0.;\n\n'
